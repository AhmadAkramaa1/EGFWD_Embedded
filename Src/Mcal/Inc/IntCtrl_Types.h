...
typedef struct
{
	NVIC_Intr_Perif_Type       NVIC_Intr_Perif;
	IntCtrl_Grp_SubGrp_Type    IntCtrl_Grp_SubGrp;
	IntCtrl_Status_Type        IntCtrl_Status;
}StrCfg_Type;
...
extern StrCfg_Type AStrCfg[INTCTRL_NB_OF_INTRS];
